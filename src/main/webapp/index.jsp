        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Enter id or name" id="search_emp">
            ...
            <div class="col-md-4 col-md-offset-4" style="text-align: right;">
                <button class="btn btn-info" id="emp_add_modal_btn">add</button>
    ...
    <script type="text/javascript">
        ...
        function build_emps_table(res) {
            ...
            $.each(emps, function (index, item) {
                ...
                var empNamdTd = $("<td></td>").append(item.empName);
        ...
        function build_page_info(res) {
            ...
            $("#page_info_area").append("current in "+res.extend.pageInfo.pageNum+" page, total "+
                res.extend.pageInfo.pages+" pages, total "+
        ...
        $("#emp_add_modal_btn").click(function () {
            ...
            //发送ajax请求，在弹出模态框【之前！】查询部门信息，显示在下拉列表中
        ...
        function validate_add_form(){
            ...
            if(!regName.test(empName)){
                ...
                show_validate_msg("#empName_add_input", "error", "username must include 6-16 digit,character or -_，or 2-5 chinese");
                return false;
            }else{
                //成功
        ...
        $("#empName_add_input").change(function () {
            ...
            $.ajax({
                ...
                success:function (res) {
                    if(res.code == 100){
                        //成功
                        show_validate_msg("#empName_add_input", "success", "Username Available!");
        ...
        function search_emps_table(res) {
            ...
            if(empSearched.length == 0){
                $("<h5 style='font-weight: bold;'></h5>").append("").append("NOT FOUND")
                    .appendTo("#emps_table tbody");//将tr添加到tbody标签中
            }else {
                ...
                $.each(empSearched, function (i, val) {
                    ...
                    var genderTd = $("<td></td>").append(empSearched[i].gender == 'M' ? "Male" : "female");
        ...
        function build_search_page_info(res) {
            ...
            $("#page_info_area").empty();
            //显示共几条记录
            $("#page_info_area").append("Query total " + res.extend.pageInfo.total +" records.");
